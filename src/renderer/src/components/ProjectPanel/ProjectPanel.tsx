...
export function ProjectPanel() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden text-foreground">
      {workspaceFolder ? (
        <div className="flex items-center gap-1.5 px-3 py-1.5 text-base min-w-0">
          ...
          <button
            className="bg-transparent border border-border rounded text-muted-foreground cursor-pointer text-sm px-1.5 shrink-0 hover:bg-secondary hover:text-foreground transition-colors"
            onClick={handleOpen}
            title="Change folder"
          >
            …
